...
ENT.EntModel = "models/bsp_eidolon/bsp_eidolon.mdl"
ENT.Vehicle = "bsp_eidolon"
...
function ENT:SpawnFunction(pl, tr)
	local e = ents.Create("bsp_eidolon");
...
if CLIENT then
	...
	local function CalcView()
		...
		local p = LocalPlayer();
		local self = p:GetNWEntity("bsp_eidolon")
		local Flying = p:GetNWBool("Flyingbsp_eidolon");
		local pos,face;
	...
	hook.Add("CalcView", "bsp_eidolonView", CalcView)
	...
	hook.Add("HUDPaint", "bsp_eidolonReticle", bsp_eidolonReticle)
