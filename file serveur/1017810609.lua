...
if CLIENT then
	...
	SWEP.PrintName = "StarWars Acoustic Guitar"
end
...
-- SWEP info
SWEP.Author			= "Annoying Rooster, edited by Kezonz"
SWEP.Contact		= ""
SWEP.Purpose		= "StarWars RP"
SWEP.Instructions	= "Left/Right Click - Random Music / R - Stop"
...
SWEP.Secondary.Sound				= Sound("swguitar/guitar_1.mp3")
...
self.Weapon:SendWeaponAnim( ACT_VM_PRIMARYATTACK )
	self.Owner:SetAnimation( PLAYER_ATTACK1 )
		local randomsounds = {
  	"weapons/swguitar/guitar_1.mp3",
  	"weapons/swguitar/guitar_2.mp3",
  	"weapons/swguitar/guitar_3.mp3",
   	"weapons/swguitar/guitar_4.mp3",
}
